...
public class CreateTablesLoadData {
    ...
    static String productCatalogTableName = "ProductCatalogK2";
    static String forumTableName = "ForumK";
    static String threadTableName = "ThreadK";
    static String replyTableName = "ReplyK";
